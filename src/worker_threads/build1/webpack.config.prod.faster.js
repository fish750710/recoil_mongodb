...
const paths = require("./pathsFaster");
...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      "@": resolve("src/" + projectName), //当前项目
      "@v": resolve("src/" + projectName + "/views"), //项目页面
      "@c": resolve("src/" + projectName + "/components"), //项目组件
      "@a": resolve("src/" + projectName + "/assets"), //图片
      "@i": resolve("src/" + projectName + "/assets/images"), //图片
    },
    plugins: [
